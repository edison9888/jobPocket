...
- (void)showGuideView
{
        ...
        (![[settings objectForKey:@"Version"] isEqualToString:oldV]))
    {
        ...
        self.guideView.backgroundColor = [UIColor blackColor];
        {
            ...
            guideScrollView.contentSize = CGSizeMake(self.guideView.bounds.size.width*5, self.guideView.bounds.size.height);
            ...
            if (iPhone5)
            {
                ...
                imageView1.image = [UIImage imageNamed:@"guideView1136_1@2x"];
                ...
                imageView2.image = [UIImage imageNamed:@"guideView1136_2@2x"];
                ...
                imageView3.image = [UIImage imageNamed:@"guideView1136_3@2x"];
                ...
                imageView4.image = [UIImage imageNamed:@"guideView1136_4@2x"];
                ...
                imageView5.image = [UIImage imageNamed:@"guideView1136_5@2x"];
