...
/*!
 @function
 @abstract 拉框搜索查询接口函数
 @param searchOption 拉框搜索查询选项(具体属性字段参考MASearchOption类中的@interface定义)
 */
-(void)spasSearchWithOption:(MASpasSearchOption*)searchOption;
...
/*!
 ...
 ）
 */
-(void)routeSearch:(MARouteSearchOption*)routeSearchOption Result:(NSArray*)result;
...
/*!
 @function
 @abstract 拉框搜索查询回调函数
 @param searchOption 发起拉框搜索查询的查询选项（具体字段参考MASearchOption类中的@interface定义）
 @param result 查询结果（具体字段参考MASearchResult类中的@interface定义）
 */
-(void)spasSearch:(MASpasSearchOption*)spasSearchOption Result:(MASpasSearchResult*)result;
@end
