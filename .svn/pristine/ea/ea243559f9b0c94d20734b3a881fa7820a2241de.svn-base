...
- (void)viewDidLoad
{
    ...
    UIImage *image2 = [UIImage imageNamed:@"recharge_byother_btn.png"];
    ...
    callsBtn.titleLabel.font = [UIFont systemFontOfSize:14];
    ...
    flowsBtn.frame = CGRectMake( 32+CGRectGetMaxX(callsBtn.frame),CGRectGetMaxY(briage.frame)+4, 120,33);
    ...
    [self.view addSubview:callsView];
    {
        ...
        UILabel *tipLb = [[UILabel alloc]initWithFrame:CGRectMake(22, yOriginal+25,300,38)] ;
        tipLb.textColor =  [UIColor blackColor];
        tipLb.text = @"充值卡密请前往查询->订单查询->已付款订单查找卡密";
...
//                }
        ...
        UILabel *label2 = [[UILabel alloc]initWithFrame:CGRectMake(22, yOriginal+92,36,12)] ;
        label2.textColor =  [UIColor blackColor];
        label2.text = @"已选择";
        label2.backgroundColor = [UIColor clearColor];
        ...
        UILabel *tipLb = [[UILabel alloc]initWithFrame:CGRectMake(22,  yOriginal+97,300,38)] ;
        tipLb.textColor =  [UIColor blackColor];
        tipLb.text = @"充值卡密请前往查询->订单查询->已付款订单查找卡密";
        tipLb.backgroundColor = [UIColor clearColor];
        tipLb.font = [UIFont systemFontOfSize:12];
...
//                                                                           img.size.width/2)];
//        
//        UIImageView *chargeView = [[UIImageView alloc]initWithFrame:CGRectMake(22, 275 , self.view.frame.size.width-44, 37)];
...
//        
//        {
//            UIImage *image1 = [UIImage imageNamed:@"recharge_commit_icon.png"];
//            UIImageView *imageView1 = [[UIImageView alloc]initWithFrame:CGRectMake(99,
//                                                                                   (chargeView.frame.size.height-17)/2,
//                                                                                   26,
//                                                                                   17)];
//            imageView1.contentMode = UIViewContentModeScaleAspectFit ;
//            imageView1.userInteractionEnabled = YES;
//            imageView1.image = image1;
//            [chargeView addSubview:imageView1];
//            
//            UILabel *label1 = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(imageView1.frame)+10, 0, 100, chargeView.frame.size.height)];
//            label1.text = @"充  值";
//            label1.backgroundColor = [UIColor clearColor];
//            label1.textColor = [UIColor whiteColor];
//            label1.font = [UIFont systemFontOfSize:14];
//            label1.textAlignment = UITextAlignmentLeft ;
//            [chargeView addSubview:label1];
//        }
        ...
        button.frame = CGRectMake(22, 275 , self.view.frame.size.width-44, 37);
    ...
    self.qrySalesProIdOpt = [MyAppDelegate.cserviceEngine postXMLWithCode:@"qrySalesProductList"
                                                        ...
                                                        onSucceeded:^(NSDictionary *dict)
                       {
                           ...
                           if (Data && [Data respondsToSelector:@selector(objectForKey:)]) {
                               NSString *TotalCount = [Data objectForKey:@"TotalCount"];
