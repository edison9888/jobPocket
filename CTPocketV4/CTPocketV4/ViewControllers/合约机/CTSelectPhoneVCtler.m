...
- (void)viewDidLoad
{
    ...
    
    {
        ...
        view.backgroundColor = [UIColor clearColor];
//        UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetHeight(self.view.frame)-56, CGRectGetWidth(self.view.frame), 56)];
...
//    NSLog(@"销售价格%f \r\n市场价格 %@",self.qryBdSalesComInfoModel.SalesProdDisPrice,self.qryBdSalesComInfoModel.MarketPrice);
    ...
    {
        [self.tableView scrollToRowAtIndexPath:[NSIndexPath indexPathForRow:0 inSection:9] atScrollPosition:UITableViewScrollPositionBottom animated:NO];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 1 || indexPath.section == 2 || indexPath.section == 4) {
        ...
        if (indexPath.section == 1) {//销售品名称  OK
            ...
            cell.autoLabel.font = [UIFont systemFontOfSize:15];
    ...
    
    {
        ...
        if (indexPath.section == 0) {
            if (self.pagedFlowView == nil) {
                self.pagedFlowView = [[CTPRcScrollview alloc] initWithFrame:CGRectMake(0, 0, self.view.bounds.size.width, [self tableView:tableView heightForRowAtIndexPath:indexPath])];
...
- (UIView *)pageAtIndex:(NSInteger)index
{
    ...
    UIImageView *imageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.view.frame), [self tableView:self.tableView heightForRowAtIndexPath:[NSIndexPath indexPathForRow:0 inSection:0]])];
