...
- (void)setLayoutView
{
    ...
    // 兑换礼品
    _cardNameLabel =  [[UILabel alloc] initWithFrame:CGRectMake(xOffset, yOffset, 280, 14)];
    ...
    _cardNameLabel.text = [NSString stringWithFormat:@"兑换礼品：         %@", self.commodityName?self.commodityName:@""];
