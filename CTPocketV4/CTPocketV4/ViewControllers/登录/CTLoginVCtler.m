...
//    [TrackingHelper trackPageLoadedState:NSStringFromClass([self class])];
    ...
    // 验证码提示语
    {
        self.tipLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 138+18, 260, 15)];
        ...
        self.tipLabel.text = @"已发送随机密码到您的手机，请注意查收！";
            ...
            [MyAppDelegate.cserviceEngine postXMLWithCode:@"loginInfo"
                                              ...
                                              onSucceeded:^(NSDictionary *dict) {
                                                  ...
                                                  [weakSelf dismissViewControllerAnimated:YES completion:^(void){
                                                      ...
                                                      {
                                                          [MyAppDelegate gotoSomeViewAfterLogin:MyAppDelegate.jumpInfo];
