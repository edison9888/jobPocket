...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        {
            UILabel *autoLB = [[UILabel alloc]initWithFrame:CGRectMake(XStart + ImageSize + XDistance, YStart, LabelWidth, LabelHeight)];
        ...
        {
            UILabel *autoLB = [[UILabel alloc]initWithFrame:CGRectMake(XStart + ImageSize + XDistance, YStart + LabelHeight, LabelWidth, LabelHeight)];
            autoLB.font = [UIFont boldSystemFontOfSize:14.0f];
            autoLB.backgroundColor = [UIColor clearColor];
        ...
        {
            ThreeSubView *threeSubView = [[ThreeSubView alloc] initWithFrame:CGRectMake(XStart + ImageSize + XDistance, YStart + LabelHeight * 2, 0, LabelHeight) leftButtonSelectBlock:nil centerButtonSelectBlock:nil rightButtonSelectBlock:nil];
        ...
        {
            UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(XStart + ImageSize + XDistance, YStart + LabelHeight * 3, LabelHeight, LabelHeight)];
            imageView.backgroundColor = [UIColor clearColor];
            [self.contentView addSubview:imageView];
        ...
        {
            UILabel *autoLB = [[UILabel alloc]initWithFrame:CGRectMake(XStart + ImageSize + XDistance + LabelHeight + 5, YStart + LabelHeight * 3, LabelWidth - LabelHeight - 5, LabelHeight)];
            autoLB.font = [UIFont boldSystemFontOfSize:14.0f];
            autoLB.backgroundColor = [UIColor clearColor];
