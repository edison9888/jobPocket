...
@interface CTTopPrettyNumVCtler () <UITableViewDataSource,UITableViewDelegate>
...
@property (nonatomic, strong) NSString *searchText; //搜索关键字
...
@property (nonatomic, strong) CTCity *selectedInfo; //选中的号码信息
@property (nonatomic, strong) NSDictionary *luckyInfo;

@end

@implementation CTTopPrettyNumVCtler
    ...
    [view setCollectedBlock: ^(int collectIndex,BOOL collectedStatus)
     {
         ...
         [[NSNotificationCenter defaultCenter] postNotificationName:COLLECTPRETTYNUMBERCOUNT object:nil]; //更新收藏上的数目
     }];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section==1) {
        ...
        if (self.type == normalModel) {
            ...
            if(cell == nil)
            {
                cell = [[CTPrettyNumViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier ViewListCellType:topListCellType];
                cell.selectionStyle = UITableViewCellSelectionStyleNone;
            }
