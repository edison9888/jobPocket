...
- (void)layoutSubviews
{
    ...
    if (self.packageModel.AmoutBack.length > 0) {
        ...
        /*
        CGRect rect_tip=CGRectMake(xOffset, yOffset-2, 40, 20);
        UILabel *label_tip_=[[[UILabel alloc] init] initWithFrame:rect_tip];
        label_tip_.font = [UIFont systemFontOfSize:12];
        label_tip_.backgroundColor = [UIColor clearColor];
        label_tip_.textColor = [UIColor colorWithR:49 G:49 B:49 A:1]; 
        label_tip_.text=@"月返还：￥%@";
        [self.contentView addSubview:label_tip_];
        */
...
//        yOffset += ContentHeight + VerticalButtonDistance;
        ...
        /*
        ThreeSubView *threeSubView = [self threeSubViewWithOrigin:CGPointMake(xOffset, yOffset) leftTitle:@"月返还：￥" centerTitle:txt_auto];
        [self.contentView addSubview:threeSubView];
    ...
    /**
     短信
     */
    if (self.packageModel.TsDx.length > 0) {
        ThreeSubView *threeSubView = [self threeSubViewWithOrigin:CGPointMake(xOffset, yOffset) leftImageName:@"PhoneDetailMessage" centerTitle:self.packageModel.TsDx];
        [self.contentView addSubview:threeSubView];
    ...
    /**
     彩信
     */
    if (self.packageModel.TsCx.length > 0) {
        ThreeSubView *threeSubView = [self threeSubViewWithOrigin:CGPointMake(xOffset, yOffset) leftImageName:@"PhoneDetailMessage" centerTitle:self.packageModel.TsCx];
        [self.contentView addSubview:threeSubView];
