 ...
 */
@protocol ES_PBMessage_Builder<NSObject>
 ...
 */
- (id<ES_PBMessage_Builder>) mergeFromCodedInputStream:(ES_PBCodedInputStream*) input extensionRegistry:(ES_PBExtensionRegistry*) extensionRegistry;
 ...
 */
- (id<ES_PBMessage_Builder>) mergeFromData:(NSData*) data extensionRegistry:(ES_PBExtensionRegistry*) extensionRegistry;
 ...
 * {@link #mergeFrom(CodedInputStream,ExtensionRegistry)}.
 */
- (id<ES_PBMessage_Builder>) mergeFromInputStream:(NSInputStream*) input extensionRegistry:(ES_PBExtensionRegistry*) extensionRegistry;
@end
