...
- (UIButton *)buttonForItemIndex:(NSUInteger)index
{
	...
	switch (item.type) {
		...
		default:
			normalImage = [UIImage imageNamed:@"common_alert_button"];//[UIImage imageNamed:@"SIAlertView.bundle/button-default"];
//			highlightedImage = [UIImage imageNamed:@"SIAlertView.bundle/button-default-d"];
    ...
    normalImage = [normalImage stretchableImageWithLeftCapWidth:hInset topCapHeight:vInset];
    highlightedImage = [highlightedImage stretchableImageWithLeftCapWidth:hInset topCapHeight:vInset];
