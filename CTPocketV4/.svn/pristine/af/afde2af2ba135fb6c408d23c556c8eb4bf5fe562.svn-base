...
- (void) setHasPimGroupId:(BOOL) value_ {
  hasPimGroupId_ = !!value_;
}
@synthesize pimGroupId;
- (BOOL) hasLastSource {
  return !!hasLastSource_;
}
- (void) setHasLastSource:(BOOL) value_ {
  hasLastSource_ = !!value_;
}
...
- (int32_t) serializedSize {
  ...
  size_ = 0;
  if (self.hasServerId) {
    size_ += ES_computeInt32Size(1, self.serverId);
  }
  if (self.hasVersion) {
    size_ += ES_computeInt32Size(2, self.version);
  }
  if (self.hasName) {
    size_ += ES_computeStringSize(3, self.name);
  }
  if (self.hasPimGroupId) {
    size_ += ES_computeStringSize(4, self.pimGroupId);
  }
  if (self.hasLastSource) {
    size_ += ES_computeInt32Size(5, self.lastSource);
  }
...
+ (Group*) parseFromData:(NSData*) data extensionRegistry:(ES_PBExtensionRegistry*) extensionRegistry {
...
+ (Group*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(ES_PBExtensionRegistry*) extensionRegistry {
  return (Group*)[[[Group builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (Group*) parseFromCodedInputStream:(ES_PBCodedInputStream*) input {
  return (Group*)[[[Group builder] mergeFromCodedInputStream:input] build];
}
+ (Group*) parseFromCodedInputStream:(ES_PBCodedInputStream*) input extensionRegistry:(ES_PBExtensionRegistry*) extensionRegistry {
...
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  ...
  if (self.hasPimGroupId) {
    [output appendFormat:@"%@%@: %@\n", indent, @"pimGroupId", self.pimGroupId];
  }
  if (self.hasLastSource) {
    [output appendFormat:@"%@%@: %@\n", indent, @"lastSource", [NSNumber numberWithInt:self.lastSource]];
  }
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[Group class]]) {
    return NO;
  }
  Group *otherMessage = other;
  return
      ...
      self.hasPimGroupId == otherMessage.hasPimGroupId &&
      (!self.hasPimGroupId || [self.pimGroupId isEqual:otherMessage.pimGroupId]) &&
      self.hasLastSource == otherMessage.hasLastSource &&
      (!self.hasLastSource || self.lastSource == otherMessage.lastSource) &&
...
- (NSUInteger) hash {
  ...
  if (self.hasPimGroupId) {
    hashCode = hashCode * 31 + [self.pimGroupId hash];
  }
  if (self.hasLastSource) {
    hashCode = hashCode * 31 + [[NSNumber numberWithInt:self.lastSource] hash];
  }
...
- (Group_Builder*) mergeFromCodedInputStream:(ES_PBCodedInputStream*) input {
  return [self mergeFromCodedInputStream:input extensionRegistry:[ES_PBExtensionRegistry emptyRegistry]];
}
- (Group_Builder*) mergeFromCodedInputStream:(ES_PBCodedInputStream*) input extensionRegistry:(ES_PBExtensionRegistry*) extensionRegistry {
...
- (void) setHasEmployed:(BOOL) value_ {
  hasEmployed_ = !!value_;
}
@synthesize employed;
- (BOOL) hasBirthday {
...
- (void) setHasMobilePhone:(BOOL) value_ {
  hasMobilePhone_ = !!value_;
}
@synthesize mobilePhone;
- (BOOL) hasWorkMobilePhone {
  return !!hasWorkMobilePhone_;
}
- (void) setHasWorkMobilePhone:(BOOL) value_ {
  hasWorkMobilePhone_ = !!value_;
}
...
- (void) setHasWorkTelephone:(BOOL) value_ {
  hasWorkTelephone_ = !!value_;
}
@synthesize workTelephone;
- (BOOL) hasHomeTelephone {
  return !!hasHomeTelephone_;
}
- (void) setHasHomeTelephone:(BOOL) value_ {
  hasHomeTelephone_ = !!value_;
}
@synthesize homeTelephone;
- (BOOL) hasFax {
  return !!hasFax_;
}
- (void) setHasFax:(BOOL) value_ {
  hasFax_ = !!value_;
}
@synthesize fax;
- (BOOL) hasHomeFax {
...
- (void) setHasHomeFax:(BOOL) value_ {
  hasHomeFax_ = !!value_;
}
@synthesize homeFax;
- (BOOL) hasWorkFax {
...
- (void) setHasWorkFax:(BOOL) value_ {
  hasWorkFax_ = !!value_;
}
@synthesize workFax;
- (BOOL) hasVpn {
...
- (void) setHasWorkEmail:(BOOL) value_ {
  hasWorkEmail_ = !!value_;
}
@synthesize workEmail;
- (BOOL) hasComEmail {
  return !!hasComEmail_;
}
- (void) setHasComEmail:(BOOL) value_ {
  hasComEmail_ = !!value_;
}
@synthesize comEmail;
- (BOOL) hasWorkAddr {
...
- (void) setHasWorkAddr:(BOOL) value_ {
  hasWorkAddr_ = !!value_;
}
@synthesize workAddr;
- (BOOL) hasHomeAddr {
...
- (void) setHasHomeAddr:(BOOL) value_ {
  hasHomeAddr_ = !!value_;
}
@synthesize homeAddr;
- (BOOL) hasQq {
...
- (void) setHasPersonPage:(BOOL) value_ {
  hasPersonPage_ = !!value_;
}
@synthesize personPage;
- (BOOL) hasComPage {
  return !!hasComPage_;
}
- (void) setHasComPage:(BOOL) value_ {
  hasComPage_ = !!value_;
}
@synthesize comPage;
- (BOOL) hasEPhone {
...
- (void) setHasPimContactId:(BOOL) value_ {
  hasPimContactId_ = !!value_;
}
...
- (void) setHasLunarBirthday:(BOOL) value_ {
  hasLunarBirthday_ = !!value_;
}
...
- (int32_t) serializedSize {
  ...
  if (self.hasFavorite) {
    size_ += ES_computeBoolSize(3, self.favorite);
  }
  if (self.hasName) {
    size_ += ES_computeMessageSize(5, self.name);
  }
  if (self.hasGender) {
    size_ += ES_computeEnumSize(6, self.gender);
  }
  if (self.hasEmployed) {
    size_ += ES_computeMessageSize(7, self.employed);
  }
  if (self.hasBirthday) {
    size_ += ES_computeStringSize(8, self.birthday);
  }
  if (self.hasBloodType) {
    size_ += ES_computeEnumSize(9, self.bloodType);
  }
  if (self.hasConstellation) {
    size_ += ES_computeEnumSize(10, self.constellation);
  }
  if (self.hasComment) {
    size_ += ES_computeStringSize(11, self.comment);
  }
  {
    int32_t dataSize = 0;
  ...
  if (self.hasMobilePhone) {
    size_ += ES_computeMessageSize(13, self.mobilePhone);
  }
  if (self.hasWorkMobilePhone) {
    size_ += ES_computeMessageSize(14, self.workMobilePhone);
  }
  if (self.hasTelephone) {
    size_ += ES_computeMessageSize(15, self.telephone);
  }
  if (self.hasWorkTelephone) {
    size_ += ES_computeMessageSize(16, self.workTelephone);
  }
  if (self.hasHomeTelephone) {
    size_ += ES_computeMessageSize(17, self.homeTelephone);
  }
  if (self.hasFax) {
    size_ += ES_computeMessageSize(18, self.fax);
  }
  if (self.hasHomeFax) {
    size_ += ES_computeMessageSize(19, self.homeFax);
  }
  if (self.hasWorkFax) {
    size_ += ES_computeMessageSize(20, self.workFax);
  }
  if (self.hasVpn) {
    size_ += ES_computeMessageSize(21, self.vpn);
  }
  if (self.hasEmail) {
    size_ += ES_computeMessageSize(22, self.email);
  }
  if (self.hasWorkEmail) {
    size_ += ES_computeMessageSize(23, self.workEmail);
  }
  if (self.hasComEmail) {
    size_ += ES_computeMessageSize(24, self.comEmail);
  }
  if (self.hasWorkAddr) {
    size_ += ES_computeMessageSize(25, self.workAddr);
  }
  if (self.hasHomeAddr) {
    size_ += ES_computeMessageSize(26, self.homeAddr);
  }
  if (self.hasQq) {
    size_ += ES_computeMessageSize(27, self.qq);
  }
  if (self.hasMsn) {
    size_ += ES_computeMessageSize(28, self.msn);
  }
  if (self.hasPersonPage) {
    size_ += ES_computeMessageSize(29, self.personPage);
  }
  if (self.hasComPage) {
    size_ += ES_computeMessageSize(30, self.comPage);
  }
  if (self.hasEPhone) {
    size_ += ES_computeMessageSize(31, self.ePhone);
  }
  if (self.hasPimContactId) {
    size_ += ES_computeStringSize(32, self.pimContactId);
  }
  if (self.hasLastSource) {
    size_ += ES_computeInt32Size(33, self.lastSource);
  }
  if (self.hasLunarBirthday) {
    size_ += ES_computeStringSize(34, self.lunarBirthday);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
...
+ (Contact*) parseFromData:(NSData*) data extensionRegistry:(ES_PBExtensionRegistry*) extensionRegistry {
...
+ (Contact*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(ES_PBExtensionRegistry*) extensionRegistry {
  return (Contact*)[[[Contact builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (Contact*) parseFromCodedInputStream:(ES_PBCodedInputStream*) input {
  return (Contact*)[[[Contact builder] mergeFromCodedInputStream:input] build];
}
+ (Contact*) parseFromCodedInputStream:(ES_PBCodedInputStream*) input extensionRegistry:(ES_PBExtensionRegistry*) extensionRegistry {
...
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  ...
  if (self.hasEmployed) {
    [output appendFormat:@"%@%@ {\n", indent, @"employed"];
    [self.employed writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  if (self.hasBirthday) {
  ...
  if (self.hasBloodType) {
    [output appendFormat:@"%@%@: %d\n", indent, @"bloodType", self.bloodType];
  }
  if (self.hasConstellation) {
    [output appendFormat:@"%@%@: %d\n", indent, @"constellation", self.constellation];
  }
  if (self.hasComment) {
  ...
  if (self.hasMobilePhone) {
    [output appendFormat:@"%@%@ {\n", indent, @"mobilePhone"];
    [self.mobilePhone writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  if (self.hasWorkMobilePhone) {
    [output appendFormat:@"%@%@ {\n", indent, @"workMobilePhone"];
    [self.workMobilePhone writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  if (self.hasTelephone) {
    [output appendFormat:@"%@%@ {\n", indent, @"telephone"];
    [self.telephone writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  if (self.hasWorkTelephone) {
    [output appendFormat:@"%@%@ {\n", indent, @"workTelephone"];
    [self.workTelephone writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  if (self.hasHomeTelephone) {
    [output appendFormat:@"%@%@ {\n", indent, @"homeTelephone"];
    [self.homeTelephone writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  if (self.hasFax) {
    [output appendFormat:@"%@%@ {\n", indent, @"fax"];
    [self.fax writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  if (self.hasHomeFax) {
    [output appendFormat:@"%@%@ {\n", indent, @"homeFax"];
    [self.homeFax writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  if (self.hasWorkFax) {
    [output appendFormat:@"%@%@ {\n", indent, @"workFax"];
    [self.workFax writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  if (self.hasVpn) {
    [output appendFormat:@"%@%@ {\n", indent, @"vpn"];
    [self.vpn writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  if (self.hasEmail) {
    [output appendFormat:@"%@%@ {\n", indent, @"email"];
    [self.email writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  if (self.hasWorkEmail) {
    [output appendFormat:@"%@%@ {\n", indent, @"workEmail"];
    [self.workEmail writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  if (self.hasComEmail) {
    [output appendFormat:@"%@%@ {\n", indent, @"comEmail"];
    [self.comEmail writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  if (self.hasWorkAddr) {
    [output appendFormat:@"%@%@ {\n", indent, @"workAddr"];
    [self.workAddr writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  if (self.hasHomeAddr) {
    [output appendFormat:@"%@%@ {\n", indent, @"homeAddr"];
    [self.homeAddr writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  if (self.hasQq) {
    [output appendFormat:@"%@%@ {\n", indent, @"qq"];
    [self.qq writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  if (self.hasMsn) {
    [output appendFormat:@"%@%@ {\n", indent, @"msn"];
    [self.msn writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  if (self.hasPersonPage) {
    [output appendFormat:@"%@%@ {\n", indent, @"personPage"];
    [self.personPage writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  if (self.hasComPage) {
    [output appendFormat:@"%@%@ {\n", indent, @"comPage"];
    [self.comPage writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  if (self.hasEPhone) {
    [output appendFormat:@"%@%@ {\n", indent, @"ePhone"];
    [self.ePhone writeDescriptionTo:output
                         withIndent:[NSString stringWithFormat:@"%@  ", indent]];
    [output appendFormat:@"%@}\n", indent];
  }
  if (self.hasPimContactId) {
    [output appendFormat:@"%@%@: %@\n", indent, @"pimContactId", self.pimContactId];
  }
  if (self.hasLastSource) {
    [output appendFormat:@"%@%@: %@\n", indent, @"lastSource", [NSNumber numberWithInt:self.lastSource]];
  }
  if (self.hasLunarBirthday) {
    [output appendFormat:@"%@%@: %@\n", indent, @"lunarBirthday", self.lunarBirthday];
  }
  [self.unknownFields writeDescriptionTo:output withIndent:indent];
}
- (BOOL) isEqual:(id)other {
  ...
  return
      ...
      self.hasEmployed == otherMessage.hasEmployed &&
      (!self.hasEmployed || [self.employed isEqual:otherMessage.employed]) &&
      ...
      self.hasWorkMobilePhone == otherMessage.hasWorkMobilePhone &&
      (!self.hasWorkMobilePhone || [self.workMobilePhone isEqual:otherMessage.workMobilePhone]) &&
      self.hasTelephone == otherMessage.hasTelephone &&
      (!self.hasTelephone || [self.telephone isEqual:otherMessage.telephone]) &&
      self.hasWorkTelephone == otherMessage.hasWorkTelephone &&
      (!self.hasWorkTelephone || [self.workTelephone isEqual:otherMessage.workTelephone]) &&
      self.hasHomeTelephone == otherMessage.hasHomeTelephone &&
      (!self.hasHomeTelephone || [self.homeTelephone isEqual:otherMessage.homeTelephone]) &&
      self.hasFax == otherMessage.hasFax &&
      (!self.hasFax || [self.fax isEqual:otherMessage.fax]) &&
      self.hasHomeFax == otherMessage.hasHomeFax &&
      (!self.hasHomeFax || [self.homeFax isEqual:otherMessage.homeFax]) &&
      self.hasWorkFax == otherMessage.hasWorkFax &&
      (!self.hasWorkFax || [self.workFax isEqual:otherMessage.workFax]) &&
      self.hasVpn == otherMessage.hasVpn &&
      (!self.hasVpn || [self.vpn isEqual:otherMessage.vpn]) &&
      self.hasEmail == otherMessage.hasEmail &&
      (!self.hasEmail || [self.email isEqual:otherMessage.email]) &&
      self.hasWorkEmail == otherMessage.hasWorkEmail &&
      (!self.hasWorkEmail || [self.workEmail isEqual:otherMessage.workEmail]) &&
      self.hasComEmail == otherMessage.hasComEmail &&
      (!self.hasComEmail || [self.comEmail isEqual:otherMessage.comEmail]) &&
      self.hasWorkAddr == otherMessage.hasWorkAddr &&
      (!self.hasWorkAddr || [self.workAddr isEqual:otherMessage.workAddr]) &&
      self.hasHomeAddr == otherMessage.hasHomeAddr &&
      (!self.hasHomeAddr || [self.homeAddr isEqual:otherMessage.homeAddr]) &&
      self.hasQq == otherMessage.hasQq &&
      (!self.hasQq || [self.qq isEqual:otherMessage.qq]) &&
      self.hasMsn == otherMessage.hasMsn &&
      (!self.hasMsn || [self.msn isEqual:otherMessage.msn]) &&
      self.hasPersonPage == otherMessage.hasPersonPage &&
      (!self.hasPersonPage || [self.personPage isEqual:otherMessage.personPage]) &&
      self.hasComPage == otherMessage.hasComPage &&
      (!self.hasComPage || [self.comPage isEqual:otherMessage.comPage]) &&
      self.hasEPhone == otherMessage.hasEPhone &&
      (!self.hasEPhone || [self.ePhone isEqual:otherMessage.ePhone]) &&
      self.hasPimContactId == otherMessage.hasPimContactId &&
      (!self.hasPimContactId || [self.pimContactId isEqual:otherMessage.pimContactId]) &&
      self.hasLastSource == otherMessage.hasLastSource &&
      (!self.hasLastSource || self.lastSource == otherMessage.lastSource) &&
      self.hasLunarBirthday == otherMessage.hasLunarBirthday &&
      (!self.hasLunarBirthday || [self.lunarBirthday isEqual:otherMessage.lunarBirthday]) &&
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
  NSUInteger hashCode = 7;
  ...
  if (self.hasEmployed) {
    hashCode = hashCode * 31 + [self.employed hash];
  }
  if (self.hasBirthday) {
    hashCode = hashCode * 31 + [self.birthday hash];
  }
  if (self.hasBloodType) {
    hashCode = hashCode * 31 + self.bloodType;
  }
  if (self.hasConstellation) {
    hashCode = hashCode * 31 + self.constellation;
  }
  if (self.hasComment) {
  ...
  if (self.hasWorkMobilePhone) {
    hashCode = hashCode * 31 + [self.workMobilePhone hash];
  }
  if (self.hasTelephone) {
    hashCode = hashCode * 31 + [self.telephone hash];
  }
  if (self.hasWorkTelephone) {
    hashCode = hashCode * 31 + [self.workTelephone hash];
  }
  if (self.hasHomeTelephone) {
    hashCode = hashCode * 31 + [self.homeTelephone hash];
  }
  if (self.hasFax) {
    hashCode = hashCode * 31 + [self.fax hash];
  }
  if (self.hasHomeFax) {
    hashCode = hashCode * 31 + [self.homeFax hash];
  }
  if (self.hasWorkFax) {
    hashCode = hashCode * 31 + [self.workFax hash];
  }
  if (self.hasVpn) {
    hashCode = hashCode * 31 + [self.vpn hash];
  }
  if (self.hasEmail) {
    hashCode = hashCode * 31 + [self.email hash];
  }
  if (self.hasWorkEmail) {
    hashCode = hashCode * 31 + [self.workEmail hash];
  }
  if (self.hasComEmail) {
    hashCode = hashCode * 31 + [self.comEmail hash];
  }
  if (self.hasWorkAddr) {
    hashCode = hashCode * 31 + [self.workAddr hash];
  }
  if (self.hasHomeAddr) {
    hashCode = hashCode * 31 + [self.homeAddr hash];
  }
  if (self.hasQq) {
    hashCode = hashCode * 31 + [self.qq hash];
  }
  if (self.hasMsn) {
    hashCode = hashCode * 31 + [self.msn hash];
  }
  if (self.hasPersonPage) {
    hashCode = hashCode * 31 + [self.personPage hash];
  }
  if (self.hasComPage) {
    hashCode = hashCode * 31 + [self.comPage hash];
  }
  if (self.hasEPhone) {
    hashCode = hashCode * 31 + [self.ePhone hash];
  }
  if (self.hasPimContactId) {
    hashCode = hashCode * 31 + [self.pimContactId hash];
  }
  if (self.hasLastSource) {
    hashCode = hashCode * 31 + [[NSNumber numberWithInt:self.lastSource] hash];
  }
  if (self.hasLunarBirthday) {
    hashCode = hashCode * 31 + [self.lunarBirthday hash];
  }
  hashCode = hashCode * 31 + [self.unknownFields hash];
  return hashCode;
}
...
- (Contact_Builder*) mergeFromCodedInputStream:(ES_PBCodedInputStream*) input {
  return [self mergeFromCodedInputStream:input extensionRegistry:[ES_PBExtensionRegistry emptyRegistry]];
}
- (Contact_Builder*) mergeFromCodedInputStream:(ES_PBCodedInputStream*) input extensionRegistry:(ES_PBExtensionRegistry*) extensionRegistry {
  ES_PBUnknownFieldSet_Builder* unknownFields = [ES_PBUnknownFieldSet builderWithUnknownFields:self.unknownFields];
  while (YES) {
    int32_t tag = [input readTag];
    switch (tag) {
