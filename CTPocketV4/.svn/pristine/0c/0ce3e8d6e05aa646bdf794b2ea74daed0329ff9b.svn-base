...
- (UIView *)headerView
{
    if (!_headerView) {
        ...
        float yPos = 0;
        {
            ...
            UILabel *infolabel = [[UILabel alloc] initWithFrame:CGRectMake(44,yPos, _headerView.frame.size.width, 18)];
            ...
            UILabel *pricelabel = [[UILabel alloc] initWithFrame:CGRectMake(44, yPos, _headerView.frame.size.width, 18)];
