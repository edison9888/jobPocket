...
@class ES_PBUnknownFieldSet;
@class ES_RingBuffer;
@protocol ES_PBMessage;

@interface ES_PBCodedOutputStream : NSObject {
    NSOutputStream *output;
    ES_RingBuffer *buffer;
}
...
#if 0   // modified by zy, 2014-03-05，解决warning，函数重复声明
- (void) writeRawLittleEndian32:(int32_t) value;
- (void) writeRawLittleEndian64:(int64_t) value;
#endif
