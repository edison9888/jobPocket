    ...
    [MyAppDelegate.cserviceEngine postXMLWithCode:@"qryFreightStateInfo"
                                      ...
                                      onSucceeded:^(NSDictionary *dict) {
                                          ...
                                          // 现实物流信息
                                          {
                                              ...
                                              if ([dict[@"Data"][@"FreightStateList"] isKindOfClass:[NSArray class]])
                                              {
                                                  tList = [NSArray arrayWithArray:dict[@"Data"][@"FreightStateList"]];
                                              }
                                              else if ([dict[@"Data"][@"FreightStateList"] isKindOfClass:[NSDictionary class]])
                                              {
                                                  tList = [NSArray arrayWithObject:dict[@"Data"][@"FreightStateList"]];
                                              }
