...
- (void)igProdList
{
    ...
    [self.igProdListNetworking igProdListWith:self.PageIndex PageSize:self.PageSize Sort:2 MinPrice:0 MaxPrice:self.Integral CommdityId:nil KeyWord:nil CategoryId:nil SmallCategoryId:nil finishBlock:^(NSDictionary *resultParams, NSError *error) {
