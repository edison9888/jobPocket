...
@implementation CTNumberSelectedCell
   ...
   ViewListCellType:(ViewListCellType)listCellType
{
    ...
    if (self) {
        ...
        CTNumberSelectView *firstView = [[CTNumberSelectView alloc]initWithFrame:CGRectMake(0, 0, 158, 62)
                                                              listCellType:listCellType];
        firstView.backgroundColor = [UIColor clearColor];
        self.leftView = firstView;
        [self addSubview:firstView];
        
        CTNumberSelectView *secondView = [[CTNumberSelectView alloc]initWithFrame:CGRectMake(CGRectGetMaxX(firstView.frame),
                                                                                       0,
                                                                                       158,
                                                                                       62)
                                                               listCellType:listCellType];
...
@interface CTNumberSelectView () <TTTAttributedLabelDelegate>
{
...
@implementation CTNumberSelectView
...
{
    {
        ...
        self.markLabel.text = @"";
        if ([self.data.PrepayMent floatValue]>0.0f) {
            self.markImageView.image = [UIImage imageNamed:@"BaiDa_PrettyNum"];
        } else {
            self.markImageView.image = [UIImage imageNamed:@"BaiDa_zero@2x"];
        }
