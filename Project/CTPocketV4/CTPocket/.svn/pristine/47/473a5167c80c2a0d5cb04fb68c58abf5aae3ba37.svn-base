 ...
 */
@interface ES_PBCodedInputStream : NSObject {
@private
...
- (void) readMessage:(id<ES_PBMessage_Builder>) builder extensionRegistry:(ES_PBExtensionRegistry*) extensionRegistry;

- (BOOL) readBool;
- (NSString*) readString;
- (NSData*) readData;

- (void) readGroup:(int32_t) fieldNumber builder:(id<ES_PBMessage_Builder>) builder extensionRegistry:(ES_PBExtensionRegistry*) extensionRegistry;

/**
 * Reads a {@code group} field value from the stream and merges it into the
 * given {@link UnknownFieldSet}.
 */
- (void) readUnknownGroup:(int32_t) fieldNumber builder:(ES_PBUnknownFieldSet_Builder*) builder;
