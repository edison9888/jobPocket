...
//
    ...
    //绿色边缘
    {
        ...
        UILabel *orderIdLabel = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(label7.frame), CGRectGetMaxY(timeLb.frame)+11,220, 26)];
//        [orderIdLabel setNumberOfLines:0];
        orderIdLabel.lineBreakMode = UILineBreakModeWordWrap;
        orderIdLabel.backgroundColor = [UIColor clearColor];
        orderIdLabel.text = @"32342343253432423423423";
        ...
        //当前为购买卡密成功页或失败页
        yPos = CGRectGetMaxY(orderIdLabel.frame) ;
...
- (void) setInfo {
    ...
    s = [self.orderInfo objectForKey:@"OrderId"];
