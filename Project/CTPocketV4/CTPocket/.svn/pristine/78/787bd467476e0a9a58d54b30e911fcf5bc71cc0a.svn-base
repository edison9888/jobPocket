...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    //显示用户评价警告框 added by gongxt 2014-05-28
    [Utils showRecommend];
}
...
- (void)fetchCustInfo
{
    ...
    [MyAppDelegate.cserviceEngine postXMLWithCode:@"custInfo"
                                      ...
                                      onSucceeded:^(NSDictionary *dict) {
                                          ...
                                          NSString *custName=self.custInfo[@"Cust_Name"];
                                          [_simpleInfoView setUserName:custName];
                                          [[NSNotificationCenter defaultCenter] postNotificationName:MineNameValue object:custName];
                                          // added by zy, 2014-04-18
...
- (void)fetchPointInfo
{
    ...
    [MyAppDelegate.cserviceEngine postXMLWithCode:@"pointInfo"
                                      ...
                                      onSucceeded:^(NSDictionary *dict) {
                                          ...
                                          NSString *pointValue=self.pointInfo[@"PointValue"];
                                          [_accountInfoView setAccountInfo:pointValue atIndex:4]; 
                                      } onError:^(NSError *engineError) {
