...
@interface Group : ES_PBGeneratedMessage {
@private
  BOOL hasServerId_:1;
  BOOL hasVersion_:1;
...
@interface Group_Builder : ES_PBGeneratedMessage_Builder {
@private
  Group* result;
}
...
@interface Contact : ES_PBGeneratedMessage {
@private
  BOOL hasFavorite_:1;
  BOOL hasServerId_:1;
  BOOL hasVersion_:1;
...
@interface Contact_Builder : ES_PBGeneratedMessage_Builder {
@private
  Contact* result;
}
