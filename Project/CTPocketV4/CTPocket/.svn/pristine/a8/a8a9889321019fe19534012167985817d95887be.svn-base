...
- (int32_t) serializedSize {
  ...
  if (self.hasLabel) {
    size_ += ES_computeStringSize(2, self.label);
  }
...
- (void) setHasAddrValue:(BOOL) value_ {
  hasAddrValue_ = !!value_;
}
@synthesize addrValue;
- (BOOL) hasAddrPostal {
  return !!hasAddrPostal_;
}
- (void) setHasAddrPostal:(BOOL) value_ {
  hasAddrPostal_ = !!value_;
}
...
- (int32_t) serializedSize {
  ...
  size_ = 0;
  if (self.hasCategory) {
    size_ += ES_computeMessageSize(1, self.category);
  }
  if (self.hasAddrValue) {
    size_ += ES_computeStringSize(2, self.addrValue);
  }
  if (self.hasAddrPostal) {
    size_ += ES_computeStringSize(3, self.addrPostal);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
...
- (Address_Builder*) toBuilder {
  return [Address builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasCategory) {
    [output appendFormat:@"%@%@ {\n", indent, @"category"];
  ...
  if (self.hasAddrValue) {
    [output appendFormat:@"%@%@: %@\n", indent, @"addrValue", self.addrValue];
  }
  if (self.hasAddrPostal) {
    [output appendFormat:@"%@%@: %@\n", indent, @"addrPostal", self.addrPostal];
  }
  [self.unknownFields writeDescriptionTo:output withIndent:indent];
}
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[Address class]]) {
    return NO;
  }
  Address *otherMessage = other;
  return
      self.hasCategory == otherMessage.hasCategory &&
      (!self.hasCategory || [self.category isEqual:otherMessage.category]) &&
      self.hasAddrValue == otherMessage.hasAddrValue &&
      (!self.hasAddrValue || [self.addrValue isEqual:otherMessage.addrValue]) &&
      self.hasAddrPostal == otherMessage.hasAddrPostal &&
      (!self.hasAddrPostal || [self.addrPostal isEqual:otherMessage.addrPostal]) &&
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
  NSUInteger hashCode = 7;
  ...
  if (self.hasAddrValue) {
    hashCode = hashCode * 31 + [self.addrValue hash];
  }
  if (self.hasAddrPostal) {
    hashCode = hashCode * 31 + [self.addrPostal hash];
  }
  hashCode = hashCode * 31 + [self.unknownFields hash];
  return hashCode;
}
...
- (void) setHasEmailValue:(BOOL) value_ {
  hasEmailValue_ = !!value_;
}
...
- (int32_t) serializedSize {
  ...
  if (self.hasEmailValue) {
    size_ += ES_computeStringSize(2, self.emailValue);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
...
- (Email_Builder*) toBuilder {
  return [Email builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasCategory) {
    [output appendFormat:@"%@%@ {\n", indent, @"category"];
  ...
  if (self.hasEmailValue) {
    [output appendFormat:@"%@%@: %@\n", indent, @"emailValue", self.emailValue];
  }
  [self.unknownFields writeDescriptionTo:output withIndent:indent];
}
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[Email class]]) {
    return NO;
  }
  Email *otherMessage = other;
  return
      self.hasCategory == otherMessage.hasCategory &&
      (!self.hasCategory || [self.category isEqual:otherMessage.category]) &&
      self.hasEmailValue == otherMessage.hasEmailValue &&
      (!self.hasEmailValue || [self.emailValue isEqual:otherMessage.emailValue]) &&
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
  NSUInteger hashCode = 7;
  ...
  if (self.hasEmailValue) {
    hashCode = hashCode * 31 + [self.emailValue hash];
  }
  hashCode = hashCode * 31 + [self.unknownFields hash];
  return hashCode;
}
...
- (void) setHasEmpCompany:(BOOL) value_ {
  hasEmpCompany_ = !!value_;
}
@synthesize empCompany;
- (BOOL) hasEmpDept {
  return !!hasEmpDept_;
}
- (void) setHasEmpDept:(BOOL) value_ {
  hasEmpDept_ = !!value_;
}
@synthesize empDept;
- (BOOL) hasEmpTitle {
...
- (void) setHasEmpTitle:(BOOL) value_ {
  hasEmpTitle_ = !!value_;
}
@synthesize empTitle;
- (void) dealloc {
...
- (int32_t) serializedSize {
  ...
  size_ = 0;
  if (self.hasEmpCompany) {
    size_ += ES_computeStringSize(1, self.empCompany);
  }
  if (self.hasEmpDept) {
    size_ += ES_computeStringSize(2, self.empDept);
  }
  if (self.hasEmpTitle) {
    size_ += ES_computeStringSize(3, self.empTitle);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
...
- (Employed_Builder*) toBuilder {
  return [Employed builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasEmpCompany) {
    [output appendFormat:@"%@%@: %@\n", indent, @"empCompany", self.empCompany];
  }
  if (self.hasEmpDept) {
    [output appendFormat:@"%@%@: %@\n", indent, @"empDept", self.empDept];
  }
  if (self.hasEmpTitle) {
    [output appendFormat:@"%@%@: %@\n", indent, @"empTitle", self.empTitle];
  }
  [self.unknownFields writeDescriptionTo:output withIndent:indent];
}
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[Employed class]]) {
    return NO;
  }
  Employed *otherMessage = other;
  return
      self.hasEmpCompany == otherMessage.hasEmpCompany &&
      (!self.hasEmpCompany || [self.empCompany isEqual:otherMessage.empCompany]) &&
      self.hasEmpDept == otherMessage.hasEmpDept &&
      (!self.hasEmpDept || [self.empDept isEqual:otherMessage.empDept]) &&
      self.hasEmpTitle == otherMessage.hasEmpTitle &&
      (!self.hasEmpTitle || [self.empTitle isEqual:otherMessage.empTitle]) &&
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
  NSUInteger hashCode = 7;
  if (self.hasEmpCompany) {
    hashCode = hashCode * 31 + [self.empCompany hash];
  }
  if (self.hasEmpDept) {
    hashCode = hashCode * 31 + [self.empDept hash];
  }
  if (self.hasEmpTitle) {
    hashCode = hashCode * 31 + [self.empTitle hash];
  }
  hashCode = hashCode * 31 + [self.unknownFields hash];
  return hashCode;
}
...
- (void) setHasImValue:(BOOL) value_ {
  hasImValue_ = !!value_;
}
@synthesize imValue;
- (void) dealloc {
...
- (int32_t) serializedSize {
  ...
  if (self.hasImValue) {
    size_ += ES_computeStringSize(2, self.imValue);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
...
- (InstantMessage_Builder*) toBuilder {
  return [InstantMessage builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasCategory) {
    [output appendFormat:@"%@%@ {\n", indent, @"category"];
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[InstantMessage class]]) {
    return NO;
  }
  InstantMessage *otherMessage = other;
  return
      self.hasCategory == otherMessage.hasCategory &&
      (!self.hasCategory || [self.category isEqual:otherMessage.category]) &&
      self.hasImValue == otherMessage.hasImValue &&
      (!self.hasImValue || [self.imValue isEqual:otherMessage.imValue]) &&
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
  NSUInteger hashCode = 7;
  ...
  if (self.hasImValue) {
    hashCode = hashCode * 31 + [self.imValue hash];
  }
  hashCode = hashCode * 31 + [self.unknownFields hash];
  return hashCode;
}
...
- (void) setHasFamilyName:(BOOL) value_ {
  hasFamilyName_ = !!value_;
}
@synthesize familyName;
- (BOOL) hasGivenName {
  return !!hasGivenName_;
}
- (void) setHasGivenName:(BOOL) value_ {
  hasGivenName_ = !!value_;
}
...
- (int32_t) serializedSize {
  ...
  size_ = 0;
  if (self.hasFamilyName) {
    size_ += ES_computeStringSize(1, self.familyName);
  }
  if (self.hasGivenName) {
    size_ += ES_computeStringSize(2, self.givenName);
  }
  if (self.hasNickName) {
    size_ += ES_computeStringSize(3, self.nickName);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
...
- (Name_Builder*) toBuilder {
  return [Name builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasFamilyName) {
...
- (void) setHasPhoneValue:(BOOL) value_ {
  hasPhoneValue_ = !!value_;
}
...
- (int32_t) serializedSize {
  ...
  if (self.hasPhoneValue) {
    size_ += ES_computeStringSize(2, self.phoneValue);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
...
- (Phone_Builder*) toBuilder {
  return [Phone builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasCategory) {
    [output appendFormat:@"%@%@ {\n", indent, @"category"];
  ...
  if (self.hasPhoneValue) {
    [output appendFormat:@"%@%@: %@\n", indent, @"phoneValue", self.phoneValue];
  }
  [self.unknownFields writeDescriptionTo:output withIndent:indent];
}
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[Phone class]]) {
    return NO;
  }
  Phone *otherMessage = other;
  return
      self.hasCategory == otherMessage.hasCategory &&
      (!self.hasCategory || [self.category isEqual:otherMessage.category]) &&
      self.hasPhoneValue == otherMessage.hasPhoneValue &&
      (!self.hasPhoneValue || [self.phoneValue isEqual:otherMessage.phoneValue]) &&
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
  NSUInteger hashCode = 7;
  ...
  if (self.hasPhoneValue) {
    hashCode = hashCode * 31 + [self.phoneValue hash];
  }
  hashCode = hashCode * 31 + [self.unknownFields hash];
  return hashCode;
}
...
- (void) setHasPageValue:(BOOL) value_ {
  hasPageValue_ = !!value_;
}
...
- (int32_t) serializedSize {
  ...
  if (self.hasPageValue) {
    size_ += ES_computeStringSize(2, self.pageValue);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
...
- (Website_Builder*) toBuilder {
  return [Website builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasCategory) {
    [output appendFormat:@"%@%@ {\n", indent, @"category"];
  ...
  if (self.hasPageValue) {
    [output appendFormat:@"%@%@: %@\n", indent, @"pageValue", self.pageValue];
  }
  [self.unknownFields writeDescriptionTo:output withIndent:indent];
}
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[Website class]]) {
    return NO;
  }
  Website *otherMessage = other;
  return
      self.hasCategory == otherMessage.hasCategory &&
      (!self.hasCategory || [self.category isEqual:otherMessage.category]) &&
      self.hasPageValue == otherMessage.hasPageValue &&
      (!self.hasPageValue || [self.pageValue isEqual:otherMessage.pageValue]) &&
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
  NSUInteger hashCode = 7;
  ...
  if (self.hasPageValue) {
    hashCode = hashCode * 31 + [self.pageValue hash];
  }
  hashCode = hashCode * 31 + [self.unknownFields hash];
  return hashCode;
}
...
- (void) setHasImageData:(BOOL) value_ {
  hasImageData_ = !!value_;
}
...
- (int32_t) serializedSize {
  ...
  if (self.hasImageType) {
    size_ += ES_computeEnumSize(2, self.imageType);
  }
  if (self.hasImageData) {
    size_ += ES_computeDataSize(3, self.imageData);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
...
- (PortraitData_Builder*) toBuilder {
  return [PortraitData builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasSid) {
  ...
  if (self.hasImageData) {
    [output appendFormat:@"%@%@: %@\n", indent, @"imageData", self.imageData];
  }
  [self.unknownFields writeDescriptionTo:output withIndent:indent];
}
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[PortraitData class]]) {
    return NO;
  }
  PortraitData *otherMessage = other;
  return
      self.hasSid == otherMessage.hasSid &&
      (!self.hasSid || self.sid == otherMessage.sid) &&
      self.hasImageType == otherMessage.hasImageType &&
      (!self.hasImageType || self.imageType == otherMessage.imageType) &&
      self.hasImageData == otherMessage.hasImageData &&
      (!self.hasImageData || [self.imageData isEqual:otherMessage.imageData]) &&
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
  NSUInteger hashCode = 7;
  ...
  if (self.hasImageType) {
    hashCode = hashCode * 31 + self.imageType;
  }
  if (self.hasImageData) {
    hashCode = hashCode * 31 + [self.imageData hash];
  }
  hashCode = hashCode * 31 + [self.unknownFields hash];
  return hashCode;
}
...
- (int32_t) serializedSize {
  ...
  size_ = 0;
  if (self.hasCode) {
    size_ += ES_computeInt32Size(1, self.code);
  }
  if (self.hasDescription) {
    size_ += ES_computeStringSize(2, self.description);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
...
- (UabError_Builder*) toBuilder {
  return [UabError builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasCode) {
    [output appendFormat:@"%@%@: %@\n", indent, @"code", [NSNumber numberWithInt:self.code]];
  }
  if (self.hasDescription) {
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[UabError class]]) {
    return NO;
  }
  UabError *otherMessage = other;
  return
...
- (NSUInteger) hash {
  NSUInteger hashCode = 7;
  if (self.hasCode) {
    hashCode = hashCode * 31 + [[NSNumber numberWithInt:self.code] hash];
  }
  if (self.hasDescription) {
...
- (void) setHasSendType:(BOOL) value_ {
  hasSendType_ = !!value_;
}
@synthesize sendType;
...
- (void) setHasSenderNumber:(BOOL) value_ {
  hasSenderNumber_ = !!value_;
}
...
- (void) setHasIsLocked:(BOOL) value_ {
  hasIsLocked_ = !!value_;
}
- (BOOL) isLocked {
  return !!isLocked_;
}
- (void) setIsLocked:(BOOL) value_ {
  isLocked_ = !!value_;
}
- (BOOL) hasIsRead {
  return !!hasIsRead_;
}
- (void) setHasIsRead:(BOOL) value_ {
  hasIsRead_ = !!value_;
}
- (BOOL) isRead {
  return !!isRead_;
}
- (void) setIsRead:(BOOL) value_ {
  isRead_ = !!value_;
}
- (BOOL) hasContent {
  return !!hasContent_;
...
- (void) setHasIsSendSuccess:(BOOL) value_ {
  hasIsSendSuccess_ = !!value_;
}
- (BOOL) isSendSuccess {
  return !!isSendSuccess_;
}
- (void) setIsSendSuccess:(BOOL) value_ {
  isSendSuccess_ = !!value_;
}
- (BOOL) hasMode {
  return !!hasMode_;
}
...
- (void) setHasCustomData:(BOOL) value_ {
  hasCustomData_ = !!value_;
}
...
- (int32_t) serializedSize {
  ...
  size_ = 0;
  if (self.hasId) {
    size_ += ES_computeStringSize(1, self.id);
  }
  if (self.hasType) {
    size_ += ES_computeEnumSize(2, self.type);
  }
  if (self.hasSendType) {
    size_ += ES_computeEnumSize(3, self.sendType);
  }
  if (self.hasSenderNumber) {
    size_ += ES_computeStringSize(4, self.senderNumber);
  }
  if (self.hasReceiveTime) {
    size_ += ES_computeStringSize(5, self.receiveTime);
  }
  if (self.hasIsLocked) {
    size_ += ES_computeBoolSize(6, self.isLocked);
  }
  if (self.hasIsRead) {
    size_ += ES_computeBoolSize(7, self.isRead);
  }
  if (self.hasContent) {
    size_ += ES_computeStringSize(8, self.content);
  }
  if (self.hasIsSendSuccess) {
    size_ += ES_computeBoolSize(9, self.isSendSuccess);
  }
  if (self.hasMode) {
    size_ += ES_computeInt32Size(10, self.mode);
  }
  if (self.hasCustomData) {
    size_ += ES_computeDataSize(11, self.customData);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
...
- (Sms_Builder*) toBuilder {
  return [Sms builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasId) {
    [output appendFormat:@"%@%@: %@\n", indent, @"id", self.id];
  ...
  if (self.hasSendType) {
    [output appendFormat:@"%@%@: %d\n", indent, @"sendType", self.sendType];
  }
  if (self.hasSenderNumber) {
    [output appendFormat:@"%@%@: %@\n", indent, @"senderNumber", self.senderNumber];
  }
  if (self.hasReceiveTime) {
    [output appendFormat:@"%@%@: %@\n", indent, @"receiveTime", self.receiveTime];
  }
  if (self.hasIsLocked) {
    [output appendFormat:@"%@%@: %@\n", indent, @"isLocked", [NSNumber numberWithBool:self.isLocked]];
  }
  if (self.hasIsRead) {
  ...
  if (self.hasIsSendSuccess) {
    [output appendFormat:@"%@%@: %@\n", indent, @"isSendSuccess", [NSNumber numberWithBool:self.isSendSuccess]];
  }
  if (self.hasMode) {
    [output appendFormat:@"%@%@: %@\n", indent, @"mode", [NSNumber numberWithInt:self.mode]];
  }
  if (self.hasCustomData) {
    [output appendFormat:@"%@%@: %@\n", indent, @"customData", self.customData];
  }
  [self.unknownFields writeDescriptionTo:output withIndent:indent];
}
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[Sms class]]) {
    return NO;
  }
  Sms *otherMessage = other;
  return
      ...
      self.hasSenderNumber == otherMessage.hasSenderNumber &&
      (!self.hasSenderNumber || [self.senderNumber isEqual:otherMessage.senderNumber]) &&
      self.hasReceiveTime == otherMessage.hasReceiveTime &&
      (!self.hasReceiveTime || [self.receiveTime isEqual:otherMessage.receiveTime]) &&
      self.hasIsLocked == otherMessage.hasIsLocked &&
      (!self.hasIsLocked || self.isLocked == otherMessage.isLocked) &&
      self.hasIsRead == otherMessage.hasIsRead &&
      (!self.hasIsRead || self.isRead == otherMessage.isRead) &&
      self.hasContent == otherMessage.hasContent &&
      (!self.hasContent || [self.content isEqual:otherMessage.content]) &&
      self.hasIsSendSuccess == otherMessage.hasIsSendSuccess &&
      (!self.hasIsSendSuccess || self.isSendSuccess == otherMessage.isSendSuccess) &&
      self.hasMode == otherMessage.hasMode &&
      (!self.hasMode || self.mode == otherMessage.mode) &&
      self.hasCustomData == otherMessage.hasCustomData &&
      (!self.hasCustomData || [self.customData isEqual:otherMessage.customData]) &&
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
  NSUInteger hashCode = 7;
  ...
  if (self.hasSendType) {
    hashCode = hashCode * 31 + self.sendType;
  }
  if (self.hasSenderNumber) {
    hashCode = hashCode * 31 + [self.senderNumber hash];
  }
  if (self.hasReceiveTime) {
    hashCode = hashCode * 31 + [self.receiveTime hash];
  }
  if (self.hasIsLocked) {
    hashCode = hashCode * 31 + [[NSNumber numberWithBool:self.isLocked] hash];
  }
  if (self.hasIsRead) {
  ...
  if (self.hasIsSendSuccess) {
    hashCode = hashCode * 31 + [[NSNumber numberWithBool:self.isSendSuccess] hash];
  }
  if (self.hasMode) {
    hashCode = hashCode * 31 + [[NSNumber numberWithInt:self.mode] hash];
  }
  if (self.hasCustomData) {
    hashCode = hashCode * 31 + [self.customData hash];
  }
  hashCode = hashCode * 31 + [self.unknownFields hash];
  return hashCode;
}
...
- (void) setHasIsFavourite:(BOOL) value_ {
  hasIsFavourite_ = !!value_;
}
- (BOOL) isFavourite {
  return !!isFavourite_;
}
- (void) setIsFavourite:(BOOL) value_ {
  isFavourite_ = !!value_;
}
- (void) dealloc {
  self.id = nil;
...
- (int32_t) serializedSize {
  ...
  if (self.hasIsFavourite) {
    size_ += ES_computeBoolSize(2, self.isFavourite);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
...
- (SmsSummary_Builder*) toBuilder {
  return [SmsSummary builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasId) {
    [output appendFormat:@"%@%@: %@\n", indent, @"id", self.id];
  ...
  if (self.hasIsFavourite) {
    [output appendFormat:@"%@%@: %@\n", indent, @"isFavourite", [NSNumber numberWithBool:self.isFavourite]];
  }
  [self.unknownFields writeDescriptionTo:output withIndent:indent];
}
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[SmsSummary class]]) {
    return NO;
  }
  SmsSummary *otherMessage = other;
  return
      self.hasId == otherMessage.hasId &&
      (!self.hasId || [self.id isEqual:otherMessage.id]) &&
      self.hasIsFavourite == otherMessage.hasIsFavourite &&
      (!self.hasIsFavourite || self.isFavourite == otherMessage.isFavourite) &&
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
  NSUInteger hashCode = 7;
  ...
  if (self.hasIsFavourite) {
    hashCode = hashCode * 31 + [[NSNumber numberWithBool:self.isFavourite] hash];
  }
  hashCode = hashCode * 31 + [self.unknownFields hash];
  return hashCode;
}
...
- (void) setHasCallTime:(BOOL) value_ {
  hasCallTime_ = !!value_;
}
@synthesize callTime;
- (BOOL) hasCallNumber {
...
- (void) setHasCallNumber:(BOOL) value_ {
  hasCallNumber_ = !!value_;
}
@synthesize callNumber;
- (BOOL) hasCallDuration {
  return !!hasCallDuration_;
}
- (void) setHasCallDuration:(BOOL) value_ {
  hasCallDuration_ = !!value_;
}
...
- (int32_t) serializedSize {
  ...
  if (self.hasCallTime) {
    size_ += ES_computeStringSize(3, self.callTime);
  }
  if (self.hasCallNumber) {
    size_ += ES_computeStringSize(4, self.callNumber);
  }
  if (self.hasCallDuration) {
    size_ += ES_computeInt32Size(5, self.callDuration);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
...
- (CallLog_Builder*) toBuilder {
  return [CallLog builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasId) {
    [output appendFormat:@"%@%@: %@\n", indent, @"id", self.id];
  ...
  if (self.hasCallTime) {
    [output appendFormat:@"%@%@: %@\n", indent, @"callTime", self.callTime];
  }
  if (self.hasCallNumber) {
    [output appendFormat:@"%@%@: %@\n", indent, @"callNumber", self.callNumber];
  }
  if (self.hasCallDuration) {
    [output appendFormat:@"%@%@: %@\n", indent, @"callDuration", [NSNumber numberWithInt:self.callDuration]];
  }
  [self.unknownFields writeDescriptionTo:output withIndent:indent];
}
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[CallLog class]]) {
    return NO;
  }
  CallLog *otherMessage = other;
  return
      self.hasId == otherMessage.hasId &&
      (!self.hasId || [self.id isEqual:otherMessage.id]) &&
      self.hasType == otherMessage.hasType &&
      (!self.hasType || self.type == otherMessage.type) &&
      self.hasCallTime == otherMessage.hasCallTime &&
      (!self.hasCallTime || [self.callTime isEqual:otherMessage.callTime]) &&
      self.hasCallNumber == otherMessage.hasCallNumber &&
      (!self.hasCallNumber || [self.callNumber isEqual:otherMessage.callNumber]) &&
      self.hasCallDuration == otherMessage.hasCallDuration &&
      (!self.hasCallDuration || self.callDuration == otherMessage.callDuration) &&
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
  NSUInteger hashCode = 7;
  ...
  if (self.hasCallTime) {
    hashCode = hashCode * 31 + [self.callTime hash];
  }
  if (self.hasCallNumber) {
    hashCode = hashCode * 31 + [self.callNumber hash];
  }
  if (self.hasCallDuration) {
    hashCode = hashCode * 31 + [[NSNumber numberWithInt:self.callDuration] hash];
  }
  hashCode = hashCode * 31 + [self.unknownFields hash];
  return hashCode;
}
...
- (void) setHasLastModified:(BOOL) value_ {
  hasLastModified_ = !!value_;
}
...
- (int32_t) serializedSize {
  ...
  size_ = 0;
  if (self.hasHash) {
    size_ += ES_computeStringSize(1, self.hash);
  }
  if (self.hasPath) {
    size_ += ES_computeStringSize(2, self.path);
  }
  if (self.hasLastModified) {
    size_ += ES_computeStringSize(3, self.lastModified);
  }
  if (self.hasVersion) {
    size_ += ES_computeUInt32Size(4, self.version);
  }
  if (self.hasSize) {
    size_ += ES_computeUInt64Size(5, self.size);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
...
- (FileInfo_Builder*) toBuilder {
  return [FileInfo builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasHash) {
  ...
  if (self.hasLastModified) {
    [output appendFormat:@"%@%@: %@\n", indent, @"lastModified", self.lastModified];
  }
  if (self.hasVersion) {
...
- (BOOL) isEqual:(id)other {
  ...
  return
      ...
      self.hasLastModified == otherMessage.hasLastModified &&
      (!self.hasLastModified || [self.lastModified isEqual:otherMessage.lastModified]) &&
...
- (NSUInteger) hash {
  ...
  if (self.hasLastModified) {
    hashCode = hashCode * 31 + [self.lastModified hash];
  }
  if (self.hasVersion) {
