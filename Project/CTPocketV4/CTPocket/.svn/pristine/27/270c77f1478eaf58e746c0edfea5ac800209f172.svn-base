    ...
    self.contractOpt = [MyAppDelegate.cserviceEngine postXMLWithCode:@"contractSelect"
             ...
             onSucceeded:^(NSDictionary *dict) {
                 ...
                 if (Data && [Data respondsToSelector:@selector(objectForKey:)]) {
                     ...
                     //            id acclistobj = [_contractDataSource.responseDict objectForKey:@"DataInfo"];
                     id acclistobj = nil;
                     id DataInfo;
                     ...
                     if (DataInfo) {
                         ...
                         {
                             NSLog(@"AccList error %@", acclistobj);
                         }
...
//                     acclistobj = [DataInfo objectForKey:@"Contracts"];
...
//                     _respondArray = [[NSArray alloc]initWithArray:tmparr];
                     ...
                     for (int i=0; i<_respondArray.count; i++) {
                         ...
                         if (_allArray)
                         {
//                             id nsmuArray = [[_respondArray objectAtIndex:i]objectForKey:@"ContractsInfo"];
                         
                             NSMutableArray *nsmuArray = [NSMutableArray new];
//                             NSDictionary *dictionary =nil;
                             //合约机列表(24月合约)
//                            id listobj = [[_respondArray objectAtIndex:i] objectForKey:@"ContractsInfo"];
                            id listobj = [[[_respondArray objectAtIndex:i] objectForKey:@"Contracts"]objectForKey:@"ContractsInfo"];
                             ...
                             {
//                                 id contractInfo = [listobj objectForKey:@"ContractsInfo"];
//                                 if (contractInfo && [contractInfo isKindOfClass:[NSArray class]]) {
//                                     nsmuArray = [NSMutableArray arrayWithArray:contractInfo];
//                                 }else{
//                                     [nsmuArray addObject:contractInfo];
//                                 }
                             ...
                             NSMutableArray *contractArray = [[NSMutableArray alloc] init];                   //contractArray
                             NSString *contractID;
