...
//        _diskCachePath = [paths[0] stringByAppendingPathComponent:fullNamespace];
        _diskCachePath = [[paths objectAtIndex:0] stringByAppendingPathComponent:fullNamespace];    // modify by zy  兼容4.0及以下编译器
...
//            if ([resourceValues[NSURLIsDirectoryKey] boolValue])
            if ([[resourceValues objectForKey:NSURLIsDirectoryKey] boolValue])      // modify by zy  兼容4.0及以下编译器
            {
                continue;
            }
...
//            NSDate *modificationDate = resourceValues[NSURLContentModificationDateKey];
            NSDate *modificationDate = [resourceValues objectForKey:NSURLContentModificationDateKey];     // modify by zy  兼容4.0及以下编译器
...
//            NSNumber *totalAllocatedSize = resourceValues[NSURLTotalFileAllocatedSizeKey];
            NSNumber *totalAllocatedSize = [resourceValues objectForKey:NSURLTotalFileAllocatedSizeKey];      // modify by zy  兼容4.0及以下编译器
...
//                return [obj1[NSURLContentModificationDateKey] compare:obj2[NSURLContentModificationDateKey]];
                return [[obj1 objectForKey:NSURLContentModificationDateKey] compare:[obj2 objectForKey:NSURLContentModificationDateKey]];       // modify by zy  兼容4.0及以下编译器
            }];
...
//                    NSNumber *totalAllocatedSize = resourceValues[NSURLTotalFileAllocatedSizeKey];
                    NSDictionary *resourceValues = [cacheFiles objectForKey:fileURL];  // modify by zy  兼容4.0及以下编译器
                    NSNumber *totalAllocatedSize = [resourceValues objectForKey:NSURLTotalFileAllocatedSizeKey];
                    currentCacheSize -= [totalAllocatedSize unsignedLongLongValue];
