...
{
    return [self queueRequest:path method:SVHTTPRequestMethodPOST parameters:parameters upFiles:upFiles completion:completionBlock];
}
...
- (SVHTTPRequest*)queueRequest:(NSString*)path
    ...
    SVHTTPRequest *requestOperation = (id<SVHTTPRequestPrivateMethods>)[[SVHTTPRequest alloc]
                                                                        initWithAddress:completeURLString
                                                                        method:method
                                                                        parameters:mergedParameters
                                                                        upFiles:upFiles
                                                                        completion:completionBlock];
